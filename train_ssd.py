...
def get_dataset(dataset, args):
    if dataset.lower() == 'voc':
        train_dataset = VOCLike(root='/home/ec2-user/SageMaker/Insulator_Detection_Data',splits=[(2007, 'trainval')])
        val_dataset = VOCLike(root='/home/ec2-user/SageMaker/Insulator_Detection_Data',splits=[(2007, 'test')])
